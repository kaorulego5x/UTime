...
import 'package:utime/model/timetables_content.dart';
...
class _TimetablesDisplayState extends ConsumerState<TimetablesDisplay> {
  //表示する時間割データ
  TimetablesContent timetablesContent = TimetablesContent();
          ...
          builder: (context, ref, child) {
            return Card(
              ...
              child: InkWell(
                ...
                //タップしたとき
                onTap: () {
                  ref.watch(timeTablesDisplayProvider.notifier).getLectureData(
